                           ...
                           const nike::shoe_factory::key_type& key)
{
    ...
    {
       factory.register_function<nike::base_constructor>(key, std::make_unique<T>);
       ...
       if constexpr (!std::constructible_from<T, int, float>)
       {
           ...
           factory.register_function<nike::numerics_constructor>(key, std::move(fun));
    ...
    {
       factory.register_function<nike::numerics_constructor>(key, std::make_unique<T, int, float>);
       ...
       if constexpr (!std::default_initializable<T>)
       {
           ...
           factory.register_function<nike::base_constructor>(key, std::move(fun));
